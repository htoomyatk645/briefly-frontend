...
export type TrendingSearchItem = {
  ...
  showName: string
  coverSrc: string
  /** Normalized 0–1 search volume over the last 24 hours (24 samples). */
  volume24h: number[]
...
/** Mock trending queries surfaced in the last 24 hours. */
export const TRENDING_SEARCHES: TrendingSearchItem[] = [
  {
    ...
    volume24h: [0.12, 0.18, 0.22, 0.28, 0.35, 0.42, 0.48, 0.55, 0.62, 0.68, 0.72, 0.78, 0.82, 0.88, 0.92, 0.95, 0.9, 0.85, 0.8, 0.74, 0.68, 0.6, 0.52, 0.45],
  ...
  },
  {
    ...
    showName: 'Huberman Lab',
    coverSrc: PODCAST_COVERS.huberman,
    volume24h: [0.2, 0.24, 0.3, 0.34, 0.38, 0.44, 0.5, 0.54, 0.58, 0.62, 0.66, 0.7, 0.74, 0.76, 0.78, 0.8, 0.78, 0.75, 0.7, 0.65, 0.58, 0.5, 0.42, 0.36],
  ...
  },
  {
    ...
    volume24h: [0.08, 0.1, 0.14, 0.2, 0.26, 0.32, 0.4, 0.48, 0.56, 0.64, 0.7, 0.76, 0.8, 0.84, 0.88, 0.9, 0.86, 0.8, 0.72, 0.64, 0.55, 0.46, 0.38, 0.3],
  ...
  },
  {
    ...
    volume24h: [0.15, 0.18, 0.2, 0.22, 0.25, 0.28, 0.32, 0.36, 0.4, 0.44, 0.48, 0.52, 0.55, 0.58, 0.6, 0.62, 0.6, 0.56, 0.5, 0.44, 0.38, 0.32, 0.26, 0.2],
    playCountLabel: '7.2k plays',
  },
  {
    id: 'trend-chips',
    query: 'semiconductors',
    pullQuote: 'Supply chains for chips ripple through hardware startups faster than equity markets admit.',
    showName: 'Acquired',
    coverSrc: PODCAST_COVERS.acquired,
    volume24h: [0.1, 0.12, 0.15, 0.18, 0.22, 0.26, 0.3, 0.34, 0.38, 0.42, 0.46, 0.5, 0.54, 0.58, 0.62, 0.66, 0.64, 0.6, 0.54, 0.48, 0.4, 0.34, 0.28, 0.22],
  ...
  },
  {
    ...
    volume24h: [0.18, 0.2, 0.22, 0.24, 0.26, 0.28, 0.3, 0.32, 0.34, 0.36, 0.38, 0.4, 0.42, 0.44, 0.46, 0.48, 0.46, 0.42, 0.38, 0.34, 0.3, 0.26, 0.22, 0.18],
